...
function App() {
  ...
  async function processAudioBlob(blob) {
    ...
    const { answer: answer2 } = await fetch("http://localhost:8000/generate/", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
  ...
  return /* @__PURE__ */ React.createElement("div", { style: { padding: 20, fontFamily: "sans-serif" } }, /* @__PURE__ */ React.createElement("button", { onClick: handleRecordClick }, recording ? "Stop & Process" : "Start Recording"), answer && /* @__PURE__ */ React.createElement(
    "div",
    {
      style: {
        marginTop: 20,
    ...
    /* @__PURE__ */ React.createElement("h3", null, "AI Answer"),
